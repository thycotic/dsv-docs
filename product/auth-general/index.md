...
**GCP Service Accounts**: DSV uses GCP's service accounts to enable just about anything that can be assinged a service account to access DSV.  Google Compute Engines (GCE) may also be assigned service accounts and authenticated through GCE metadata.  See [Authentication: Azure](./authgcp/index.md)
